...
void rtw_proc_init_one(struct net_device *dev)
{
	...
	{
#if LINUX_VERSION_CODE < KERNEL_VERSION(3,10,0)
		padapter->dir_dev = create_proc_entry(dev->name, S_IFDIR | S_IRUGO | S_IXUGO, rtw_proc);
#else
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(3,10,0)
	entry = create_proc_read_entry("read_reg", S_IFREG | S_IRUGO, dir_dev, proc_get_read_reg, dev);				   
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(3,10,0)
	entry = create_proc_read_entry("fwstate", S_IFREG | S_IRUGO, dir_dev, proc_get_fwstate, dev);				   
#else
	entry = proc_create_data("fwstate", S_IFREG | S_IRUGO, dir_dev, proc_get_fwstate, dev);				   
#endif
	if (!entry) {
		DBG_871X("Unable to create_proc_read_entry!\n"); 
		return;
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(3,10,0)
	entry = create_proc_read_entry("sec_info", S_IFREG | S_IRUGO, dir_dev, proc_get_sec_info, dev);				   
#else
	entry = proc_create_data("sec_info", S_IFREG | S_IRUGO, dir_dev, proc_get_sec_info, dev);				   
#endif
	if (!entry) {
		DBG_871X("Unable to create_proc_read_entry!\n"); 
		return;
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(3,10,0)
	entry = create_proc_read_entry("mlmext_state", S_IFREG | S_IRUGO, dir_dev, proc_get_mlmext_state, dev);				   
#else
	entry = proc_create_data("mlmext_state", S_IFREG | S_IRUGO, dir_dev, proc_get_mlmext_state, dev);				   
#endif
	if (!entry) {
		DBG_871X("Unable to create_proc_read_entry!\n"); 
		return;
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(3,10,0)
	entry = create_proc_read_entry("qos_option", S_IFREG | S_IRUGO, dir_dev, proc_get_qos_option, dev);				   
#else
	entry = proc_create_data("qos_option", S_IFREG | S_IRUGO, dir_dev, proc_get_qos_option, dev);				   
#endif
	if (!entry) {
		DBG_871X("Unable to create_proc_read_entry!\n"); 
		return;
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(3,10,0)
	entry = create_proc_read_entry("ht_option", S_IFREG | S_IRUGO, dir_dev, proc_get_ht_option, dev);				   
#else
	entry = proc_create_data("ht_option", S_IFREG | S_IRUGO, dir_dev, proc_get_ht_option, dev);				   
#endif
	if (!entry) {
		DBG_871X("Unable to create_proc_read_entry!\n"); 
		return;
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(3,10,0)
	entry = create_proc_read_entry("rf_info", S_IFREG | S_IRUGO, dir_dev, proc_get_rf_info, dev);				   
#else
	entry = proc_create_data("rf_info", S_IFREG | S_IRUGO, dir_dev, proc_get_rf_info, dev);				   
#endif
	if (!entry) {
		DBG_871X("Unable to create_proc_read_entry!\n"); 
		return;
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(3,10,0)
	entry = create_proc_read_entry("ap_info", S_IFREG | S_IRUGO, dir_dev, proc_get_ap_info, dev);				   
#else
	entry = proc_create_data("ap_info", S_IFREG | S_IRUGO, dir_dev, proc_get_ap_info, dev);				   
#endif
	if (!entry) {
		DBG_871X("Unable to create_proc_read_entry!\n"); 
		return;
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(3,10,0)
	entry = create_proc_read_entry("adapter_state", S_IFREG | S_IRUGO, dir_dev, proc_get_adapter_state, dev);				   
#else
	entry = proc_create_data("adapter_state", S_IFREG | S_IRUGO, dir_dev, proc_get_adapter_state, dev);				   
#endif
	if (!entry) {
		DBG_871X("Unable to create_proc_read_entry!\n"); 
		return;
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(3,10,0)
	entry = create_proc_read_entry("trx_info", S_IFREG | S_IRUGO, dir_dev, proc_get_trx_info, dev);				   
#else
	entry = proc_create_data("trx_info", S_IFREG | S_IRUGO, dir_dev, proc_get_trx_info, dev);				   
#endif
	if (!entry) {
		DBG_871X("Unable to create_proc_read_entry!\n"); 
		return;
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(3,10,0)
	entry = create_proc_read_entry("all_sta_info", S_IFREG | S_IRUGO, dir_dev, proc_get_all_sta_info, dev);				   
#else
	entry = proc_create_data("all_sta_info", S_IFREG | S_IRUGO, dir_dev, proc_get_all_sta_info, dev);				   
#endif
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(3,10,0)
	entry = create_proc_read_entry("_malloc_cnt", S_IFREG | S_IRUGO, dir_dev, proc_get_malloc_cnt, dev);				   
#else
	entry = proc_create_data("_malloc_cnt", S_IFREG | S_IRUGO, dir_dev, proc_get_malloc_cnt, dev);				   
#endif
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(3,10,0)
	entry = create_proc_read_entry("best_channel", S_IFREG | S_IRUGO, dir_dev, proc_get_best_channel, dev);				   
#else
	entry = proc_create_data("best_channel", S_IFREG | S_IRUGO, dir_dev, proc_get_best_channel, dev);				   
#endif
	if (!entry) {
		DBG_871X("Unable to create_proc_read_entry!\n"); 
		return;
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(3,10,0)
	entry = create_proc_read_entry("rx_signal", S_IFREG | S_IRUGO, dir_dev, proc_get_rx_signal, dev);				   
	entry->write_proc = proc_set_rx_signal;
#else
	entry = proc_create_data("rx_signal", S_IFREG | S_IRUGO, dir_dev, proc_get_rx_signal, dev);				   
#endif
	if (!entry) {
		DBG_871X("Unable to create_proc_read_entry!\n"); 
		return;
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(3,10,0)
	entry = create_proc_read_entry("ampdu_enable", S_IFREG | S_IRUGO, dir_dev, proc_get_ampdu_enable, dev);				   
	entry->write_proc = proc_set_ampdu_enable;
#else
	entry = proc_create_data("ampdu_enable", S_IFREG | S_IRUGO, dir_dev, proc_get_ampdu_enable, dev);				   
#endif
	if (!entry) {
		DBG_871X("Unable to create_proc_read_entry!\n"); 
		return;
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(3,10,0)
	entry = create_proc_read_entry("rssi_disp", S_IFREG | S_IRUGO, dir_dev, proc_get_rssi_disp, dev);				   
	entry->write_proc = proc_set_rssi_disp;
#else
	entry = proc_create_data("rssi_disp", S_IFREG | S_IRUGO, dir_dev, proc_get_rssi_disp, dev);				   
#endif
	if (!entry) {
		DBG_871X("Unable to create_proc_read_entry!\n"); 
		return;
